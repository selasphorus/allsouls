...
function get_person_dates( $post_id, $styled = false ) {
    ...
    allsouls_log( "function called: get_person_dates" );
    
    //allsouls_log( "[str_from_persons] arr_persons: ".print_r($arr_persons, true) );
    allsouls_log( "[get_person_dates] post_id: ".$post_id );
    //allsouls_log( "[get_person_dates] styled: ".$styled );
