...
function get_person_dates( $post_id, $styled = false ) {
    ...
    birdhive_log( "function called: get_person_dates" );
    
    //birdhive_log( "[str_from_persons] arr_persons: ".print_r($arr_persons, true) );
    birdhive_log( "[get_person_dates] post_id: ".$post_id );
    //birdhive_log( "[get_person_dates] styled: ".$styled );
